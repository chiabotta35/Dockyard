...
ARG DOCKYARD_VERSION=dev
RUN CGO_ENABLED=0 GOOS=linux go build -ldflags="-s -w -X github.com/dockyard/dockyard/internal/meta.Version=${DOCKYARD_VERSION}" -o /dockyard .
