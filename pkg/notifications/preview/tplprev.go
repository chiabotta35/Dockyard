...
//
// Dependencies:
//   - github.com/dockyard/dockyard/pkg/notifications/preview/data: Provides simulated data (PreviewData, states, logs).
//   - github.com/dockyard/dockyard/pkg/notifications/templates: Provides template functions (e.g., ToJSON).
//   - github.com/dockyard/dockyard/pkg/types: Provides Report and ContainerReport interfaces.
...
//
// For more details, see the Watchtower documentation at https://pkg.go.dev/github.com/dockyard/dockyard.
package preview
...
import (
	...
	"github.com/dockyard/dockyard/pkg/notifications/preview/data"
	"github.com/dockyard/dockyard/pkg/notifications/templates"
)
